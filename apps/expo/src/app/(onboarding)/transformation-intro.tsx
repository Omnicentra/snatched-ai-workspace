...
function TransformationIntroScreen() {
  ...
  return (
    ...
    >
      ...
      <View
        style={{ flexGrow: 1 }}
        className="p-8" // Use className for padding
      >
        {/* --- Header --- */}
        ...
        <View className="mb-12 mt-5">
          ...
          <View className="relative" style={{ height: graphHeight }}>
            ...
            <View
              ...
              style={{ bottom: yAxisPadding, left: xAxisPadding, top: 10 }}
            />
            <View
              className="absolute h-[1.5px] bg-gray-200"
              style={{ bottom: yAxisPadding, left: xAxisPadding, right: 10 }}
            />
            ...
            <Animated.View
              ...
              style={{
                ...
                transform: [
                  { translateX: -graphHeight / 2 },
                  { rotate: "-90deg" },
                  { translateX: graphHeight / 2 },
                ], // Standard rotate from center
          ...
          >
            <View className="flex-row items-center">
              ...
              <Text className="ml-1.5 text-xs text-gray-700">
                Visible Waistline
              </Text>
            </View>
            <View className="flex-row items-center">
      ...
      <View className="gap-y-4 border-t border-gray-100 bg-white p-8 pt-4">
        {/* --- Descriptive Text --- */}
        <Animated.View
          entering={FadeIn.delay(baseElementDelay + 800).duration(500)}
        >
          <Text className="text-center text-xs text-gray-500">
            Based on Snatched AI user trends, visual changes usually begin after
            Day 7 — and by Day 30, results become truly noticeable.
          </Text>
        </Animated.View>
